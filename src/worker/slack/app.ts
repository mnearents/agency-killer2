        ...
        if (route.handler === "unknown") {
          ...
          response = {
            text: [
              ...
              "• `!inventory` — What's in stock, what's running out",
              "• `!inventory alerts` — Only the stock problems worth acting on",
              "• `!sync inventory` — Pull the latest stock levels from Shopify",
